...
* To Do:
    - **QUEUE debe tener un método que retorna el mejor proceso de la cola READY** (en proceso, no alcanzé a terminarla, la termino mañana)
    - **CPU debe tener un método que retorna el peor proceso de sus cores**
    - **PROCESS debe tener un método que nos de la puntuación de un proceso o compare procesos entregando el mejor**
